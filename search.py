...
def astar_many_circles(maze):
    ...
    # point_nodes[0].g = 0; point_nodes[0].h = stage3_heuristic(point_nodes[0], point_shortest_paths)
    # #print(f"{point_nodes[0].location} : {point_nodes[0].h}")
    # for i in range(1,len(point_nodes)):
    #     point_nodes[i].g = len(point_shortest_paths[point_nodes[0].location, point_nodes[i].location])-1
    #     point_nodes[i].h = stage3_heuristic(point_nodes[i], point_shortest_paths)
    ...
    #         else:
    #             child.g = current_node.g + len(point_shortest_paths[current_node.location, child.location])-1
    #         child.h = stage3_heuristic(child, point_shortest_paths)
    #
    ...
    #     path.append(point_shortest_paths[path_tmp[i], path_tmp[i+1]])
    #
    print(path)
    return path
